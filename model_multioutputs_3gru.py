...
def trainging(storage,exp,sampleweights,char_x,pos_x,unicate_x,vocab_x,trainy_interval,trainy_operator_ex,trainy_operator_im,
    ...
    if reload ==False:
        ...
        gru_out_3 = Bidirectional(GRU(gru_size1, input_shape=(seq_length, embedding_size_char+embedding_size_pos+embedding_size_unicate+embedding_size_vocab),
                                      return_sequences=True))(input_merge)
        ...
        gru_out_5 = Bidirectional(GRU(gru_size1, input_shape=(seq_length, embedding_size_char+embedding_size_pos+embedding_size_unicate+embedding_size_vocab),
                                      return_sequences=True))(input_merge)
        ...
        model.compile(optimizer='rmsprop',
                      ...
                      loss_weights={'timedistributed_1': 1., 'timedistributed_2': 0.65,'timedistributed_3': 0.5},metrics=['fmeasure', 'categorical_accuracy','recall','precision'],
...
exp = "exp_commodel_multioutputs_3gru_newembeddingsize80323216_weights106505"
...
trainging(storage,exp,sampleweights,char_x,pos_x,unicate_x,vocab_x,trainy_interval,trainy_operator_ex,trainy_operator_im,
                                        char_x_cv,pos_x_cv,unicate_x_cv,vocab_x_cv,cv_y_interval,cv_y_operator_ex,cv_y_operator_im,batchsize,epoch_size,
                                        n_char,n_pos,n_unicate,n_vocab,reload = False,modelpath = None,embedding_size_char =80,
                                        embedding_size_pos = 32, embedding_size_unicate = 32,embedding_size_vocab =16,
                                        gru_size1 =164 ,gru_size2 = 200)
