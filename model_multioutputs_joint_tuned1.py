...
def trainging(storage,exp,sampleweights,char_x,pos_x,unicate_x,vocab_x,trainy_interval,trainy_operator_ex,trainy_operator_im,
    ...
    if reload ==False:
        ...
        input_merge2 = merge([input_merge1,interval_output], mode='concat')

        gru_out_3 = Bidirectional(GRU(gru_size3, input_shape=(seq_length, embedding_size_char+embedding_size_pos+embedding_size_unicate+embedding_size_vocab+type_size_interval),
        ...
        input_merge3 = merge([input_merge1,interval_output,explicit_operator], mode='concat')
        

        gru_out_5 = Bidirectional(GRU(gru_size5, input_shape=(seq_length, embedding_size_char+embedding_size_pos+embedding_size_unicate+embedding_size_vocab+type_size_interval+type_size_operator_ex),
        ...
        model.compile(optimizer='rmsprop',
                      ...
                      loss_weights={'timedistributed_1': 1., 'timedistributed_2': 0.5,'timedistributed_3': 0.5},metrics=['fmeasure', 'categorical_accuracy','recall','precision'],
...
exp = "exp_commodel_multioutputs_joint_tuned2"
...
trainging(storage,exp,sampleweights,char_x,pos_x,unicate_x,vocab_x,trainy_interval,trainy_operator_ex,trainy_operator_im,
                                        ...
                                        gru_size1 = 160,gru_size2 = 190,gru_size3 = 160,gru_size4 = 190,gru_size5 = 160,gru_size6 = 190)
